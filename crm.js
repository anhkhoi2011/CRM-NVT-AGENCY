...
function updateTeamRecipient(id, field, value) {
  ...
  config.weights ||= {};
  if(field==='weight'){const rawWeight=Number(value);config.weights[id]=Number.isFinite(rawWeight)?Math.max(0,Math.min(100,Math.round(rawWeight))):1;}
