...
(() => {
  ...
  if(!q('#referenceCustomerPhoneStyles')){const style=document.createElement('style');style.id='referenceCustomerPhoneStyles';style.textContent='.customer-phone-cell{white-space:nowrap;font-variant-numeric:tabular-nums;color:var(--text-main);font-weight:600;font-size:12px}.customer-reference-amount{white-space:nowrap;color:#059669;font-weight:800;font-variant-numeric:tabular-nums}';document.head.appendChild(style);}
