...
npm test: 42 kiểm tra qua tại workspace, có kiểm tra khởi tạo một lần, giữ ID, rollback, role phòng ban và lỗi đăng nhập. Test dùng CSDL/DOM giả lập; chưa xác minh MySQL/hosting thật và chưa triển khai từ phiên làm việc này. Mật khẩu admin123 trước đây được thay bằng mật khẩu mới theo yêu cầu khi migration này áp dụng lần đầu.
